...
Транспортная **сеть** в MATSim — это граф: **узлы** (перекрёстки, точки слияния) и **линки** (участки дорог или линий ОТ между узлами).

У каждого линка заданы, в частности:
...
- **Маршрутами** — последовательностью остановок и линков, по которым следует транспорт.
...
| Линк (link) | Участок дороги или линии ОТ между двумя узлами сети. |
